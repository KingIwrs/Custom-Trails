...
$execute unless data storage trails:data players[{uuid:$(uuid)}].equipped{secondary_color:""} run function trails:customize_trails/secondary_colors/get_equipped_color/start with storage trails:temp players
...
$execute if data storage trails:data players[{uuid:$(uuid)}].owned.colors[0] run function trails:customize_trails/secondary_colors/get_owned_colors/start with storage trails:temp players
